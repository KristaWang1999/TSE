...
def main(config, model_path=None, pretrain_path=None):
    ...
    from look2hear.models.tiger_modelA_64dim import TIGER as TIGER_ModelA
    from look2hear.datas.Libri2Mix16_modelA_64dim import Libri2MixModuleRemix as DataModule_ModelA
    from look2hear.system.audio_litmodule_modelA_64dim import AudioLightningModule_ModelA
    ...
    config["exp"]["exp_name"] = config["exp"]["exp_name"] + "-64dim"
    # Just after instantiating, save the args. Easy loading in the future.
    config["main_args"]["exp_dir"] = os.path.join(
        os.getcwd(), "Experiments_modelA_64dim", "checkpoint", config["exp"]["exp_name"]
    )
...
# --- Modification point ---
    ...
    logger_dir = os.path.join(os.getcwd(), "Experiments_modelA_64dim", "tensorboard_logs")
