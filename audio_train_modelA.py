...
def main(config, model_path=None, pretrain_path=None):
    ...
    from look2hear.models.tiger_modelA import TIGER as TIGER_ModelA
    from look2hear.datas.Libri2Mix16_modelA import Libri2MixModuleRemix as DataModule_ModelA
    from look2hear.system.audio_litmodule_modelA import AudioLightningModule_ModelA
    ...
    config["main_args"]["exp_dir"] = os.path.join(
        os.getcwd(), "Experiments_modelA", "checkpoint", config["exp"]["exp_name"]
    )
...
# --- Modification point ---
    ...
    logger_dir = os.path.join(os.getcwd(), "Experiments_modelA", "tensorboard_logs")
